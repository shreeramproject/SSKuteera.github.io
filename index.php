...
<div class="container text-center" style="padding:30px; ">
  <table class="table table-responsive">
    <tr>
      <td>
          <h1 class="display-4 text-ylw " style="   padding-top: 150px; "> WHAT ARE WE? </h1>
          <!-- <h4 class="ylw-no">watch the full video on youtube</h4> -->
      </td>
      <td>
          <video  autoplay loop  muted width="90%" height="400px">
      ...
      <td>
        ...
        <?php
          ...
          <div class="col-sm-4">
            <div class="card">
              <div class="card-body" >
                <h5 class="card-title"><?php echo $rows['activitesimageName'] ;?></h5>
                <img src="<?php echo "admin/uploads/".$rows['activitesImage'] ;?>" height="150px" width="300px">
              </div>
            </div>
          </div>
          <?php
                ...
                <?php
                  ...
                  if(mysqli_num_rows($query_run) > 0){
                    while($rows = mysqli_fetch_assoc($query_run)){
                      ...
                      ?>
                    <img src="<?php echo "admin/uploads/".$rows['activitesImage'] ;?>" width="300px" height="200px">
                ...
                <?php
                  ...
                  if(mysqli_num_rows($query_run) > 0){
                    while($rows = mysqli_fetch_assoc($query_run)){
                      ...
                      ?>
                    <img src="<?php echo "admin/uploads/accommodation_images/".$rows['accomoImage'] ;?>" width="300px" height="200px">
                ...
                <?php
                  ...
                  if(mysqli_num_rows($query_run) > 0){
                    while($rows = mysqli_fetch_assoc($query_run)){
                      ...
                      ?>
                    <img src="<?php echo "admin/uploads/".$rows['imagePic'] ;?>" width="300px" height="200px">
...
<div class="container-fluid mb-4 placc text-center">
  <div class="row justify-content-center row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
    ...
    <div class="col mt-4 ">
      <div class="card place" style=" background: none;">
      <h1 class="display-3 pla text-center d-none d-md-block">PLACES NEAR ME </h1>
      </div>
    </div>
    <h2 class="d-block d-md-none pla">PLACES NEAR ME</h2>
    <br>
    <div class="col mt-4 ">
      <div class="card ">
      <a href="https://goo.gl/maps/6armqC81AX3E7jgH6" target="_blank"><img class="card-image" src="img/heserghatta grasslands.jpg" ></a>
      <h2 class="cap">Heserghatta Grasslands</h2>
      </div>
    </div>
    <div class="col mt-4 ">
      <div class="card ">
